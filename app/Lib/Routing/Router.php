 ...
 */
	public static function url($url = null, $full = false) {
        ...
        $output = $output . $extension . self::queryString($q, array(), $escape) . $frag;
		return  $output ;//. ($output != "{$base}/" && CakeSession::read('language') && Configure::read('Variable.site_language_locale_url') ? '?lang=' . CakeSession::read('language') : '');
	}
