...
class Comment extends CommentAppModel {
    ...
    public function beforeValidate() {
        ...
        if (!$userId) { # anonymous
            ...
            $this->data['Comment']['status'] = $this->nodeData['NodeType']['comments_approve'];
            $this->data['Comment']['user_id'] = $userId;
        }
        
        $r = $this->hook('comment_beforeValidate', $this, array('break' => true, 'breakOn' => false));
    ...
    public function beforeSave() {
        ...
        $r = $this->hook('comment_beforeSave', $this, array('break' => true, 'breakOn' => false));
        $r = is_array($r) ? (in_array(false, $r) ? false : $r) : $r;
        return ($r === null ? true : $r);
    }
