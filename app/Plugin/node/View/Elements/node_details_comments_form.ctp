<?php $this->Layout->hook('beforeCommentsForm', $this, array('alter' => true, 'collectReturn' => false)); ?>
<div id="comment-form">
    <h2><?php echo __d('comment', 'Add new comment'); ?></h2>
...
<?php $this->Layout->hook('afterCommentsForm', $this, array('alter' => true, 'collectReturn' => false)); ?>