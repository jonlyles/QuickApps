<?php echo $this->Form->create('NodeType', array('url' => '/admin/node/types/add/') ); ?>
    ...
    <?php echo $this->Html->useTag('fieldsetstart', __t('Comments')  ); ?>
        ...
        <?php echo $this->Form->input('NodeType.comments_per_page', array('type' => 'select', 'options' => array(10 => 10, 30 => 30, 50 => 50, 70 => 70, 90 => 90, 150 => 150, 200 => 200, 250 => 250, 300 => 300), 'label' => __t('Comments per page'))); ?>
    ...
    <?php echo $this->Html->useTag('fieldsetend'); ?>
    <!--
    <?php echo $this->Html->useTag('fieldsetstart', __t('Taxonomy')  ); ?>
        <?php echo $this->Form->input('Vocabulary', array('options' => $vocabularies, 'type' => 'select', 'multiple' => true, 'label' => __t('Vocabulary'))); ?>
    <?php echo $this->Html->useTag('fieldsetend'); ?>
    -->
