<?php echo $this->Form->create('MenuLink'); ?>
    <?php echo $this->Html->useTag('fieldsetstart', __t('Edit menu link') ); ?>
        ...
        <?php if ( $this->data['MenuLink']['module'] == 'menu'): ?>
            ...
            <em><?php echo __t('The path for this menu link. This can be an internal QuickApps path such as /node/my-post or an external URL such as http://quickapps.es Enter / to link to the front page.'); ?></em>
        <?php else: ?>
