...
class Locale {
    ...
    function contries_list() {
        return self::$countries;
        $catalog = $L10n->catalog();
    }
    
    function time_zones($blank = NULL) {
    ...
    function format_date($timestamp, $type = 'medium', $format = '', $timezone = null, $langcode = null) {
        ...
        self::_format_date_callback(NULL, $langcode);

        // Translate the marked sequences.
        return preg_replace_callback('/\xEF([AaeDlMTF]?)(.*?)\xFF/', array('Locale', '_format_date_callback') , $format);        
    }
