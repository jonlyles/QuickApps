...
class PackagesController extends LocaleAppController {
    ...
    function admin_download_package($plugin, $language){
        $err = false;
    ...
    function admin_uninstall($plugin, $language){
    ...
    function admin_install(){
        ...
        if(file_exists($ppath)){
            if (
                in_array(
                    $this->data['Package']['language'], 
                    array_keys( $this->__languageList() )
                )
            ){
